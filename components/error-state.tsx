const ErrorState = () => {
  return (
    <>
      <div className="mx-auto mt-[25%] flex h-full max-w-md flex-col items-center gap-8">
        <svg
        ...
        <p className="text-destructive/80 text-lg font-medium">
          Sorry! This file can't be proccessed!
        </p>
      </div>
    </>
  );
